<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ( empty($first_name) OR empty($phone) OR empty($address) OR empty($message) OR !filter_var($email, FILTER_VALIDATE_EMAIL)) {
        ...
        $subject = "Nutras - Mail From $first_name";
